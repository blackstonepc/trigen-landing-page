    ...
    <section className="w-full min-h-[50vh] flex items-center justify-center px-6 md:px-24 py-20 bg-midnight rounded-3xl shadow-2xl my-16 max-w-6xl mx-auto">
      <div className="w-full flex flex-col md:flex-row items-start gap-16">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl font-headline font-extrabold mb-4 text-silver leading-tight tracking-tight">Ready to Start Investing?</h1>
          <div className="w-24 h-1 bg-silver rounded mb-8" />
          ...
          <div className="space-y-6 text-offwhite text-base font-body max-w-xl mb-10">
            <div className="flex items-center gap-3">
              <span className="font-semibold text-silver">Phone:</span>
            ...
            <div className="flex items-center gap-3">
              <span className="font-semibold text-silver">Address:</span>
